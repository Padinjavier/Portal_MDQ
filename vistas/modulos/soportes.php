...
<script src="<?php echo BASE_URL; ?>/vistas/assets/dist/js/funcion_soportes.js"></script>
<script>
                ...
                <div class="card-body p-4">
                    <div title="Botones para exportar">
                        ...
                        <button class="btn btn-secondary buttons-excel buttons-html5 btn-success" tabindex="0"
                            aria-controls="tableSoportes" type="button" title="Exportar a Excel">
                        ...
                        <button class="btn btn-secondary buttons-pdf buttons-html5 btn-danger" tabindex="0"
                            aria-controls="tableSoportes" type="button" title="Exportar a PDF">
                        ...
                        <button class="btn bg-secondary buttons-csv buttons-html5  disabled" tabindex="0"
                            aria-controls="tableSoportes" type="button" title="Exportar a CSV" disabled>
                            <span><i class="fas fa-file-csv"></i> CSV</span>
                        </button>

                        <!-- Botón de JSON (deshabilitado, visible, bloqueado en gris) -->
                        <button class="btn bg-secondary buttons-csv buttons-html5  disabled" tabindex="0"
                            aria-controls="tableSoportes" type="button" title="Exportar a JSON" disabled>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered w-100" id="tableSoportes"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success btn-sm" type="button" onclick="guardarSoporte()">Guardar</button>
            </div>
        </div>
    </div>
</div>
<!-- Fin Modal para Crear/Editar Soporte -->
